  ...
  return (
    <div style={{ backgroundColor: '#0D0D0D', minHeight: '100vh', padding: '60px 24px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <h1 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: 800, color: '#FFFFFF', lineHeight: 1.1, marginBottom: '16px' }}>Reach buyers in 22 countries</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '48px' }}>
          {[{ stat: '22', label: 'Countries Reached' }, { stat: 'Free', label: 'To List Products' }, { stat: '48h', label: 'Seller Approval' }].map((item) => (
