        ...
        <div className="vs-wrap">
          ...
          <div className="vs-flow">
            ...
            <div className="vs-fstep green">
              ...
              <h3>Paid, your way</h3>
              <p>Weekly payouts by Stripe where supported, Payoneer everywhere else — same rules on
              both rails, in your currency.</p>
        ...
        <div className="vs-wrap">
          <div className="vs-founding">
            <div>
              ...
              founding badge, the showreel slot, and Pro free for as long as the subscription runs
              unbroken.</p>
            </div>
