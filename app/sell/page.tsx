        ...
        <div className="vs-wrap">
          ...
          <div className="vs-flow">
            ...
            <div className="vs-fstep green">
              ...
              <h3>Paid, your way</h3>
              <p>Weekly payouts by Stripe where supported, Payoneer everywhere else — sign up today and your earnings are held safely until payout setup completes for your country.</p>
