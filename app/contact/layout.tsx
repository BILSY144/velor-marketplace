...
const description =
  'Get in touch with Velor Marketplace. Send a message through the contact form or email customerservice@velorglobalmarket.com — we reply within one business day.'
