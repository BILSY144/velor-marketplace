    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-500">Seller Agreement - Version 1.1 (July 2026)</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="px-8 py-8 prose prose-sm max-w-none text-gray-700 space-y-6 overflow-y-auto max-h-[60vh]">
            ...
            <section><h3 className="text-base font-semibold text-gray-900 mb-2">4. Platform Fees & Commission</h3><p>The Platform charges commission on each sale. Rates depend on your subscription tier:</p><ul><li><strong>Starter (Free):</strong> 15% commission on GMV. Maximum 50 active listings. Basic analytics.</li><li><strong>Pro (£49/month):</strong> 8% commission on GMV. Unlimited listings. Full analytics, custom storefront, featured listing slots, priority review, discount code tools.</li><li><strong>Enterprise (£199/month, fixed):</strong> 5% commission on GMV. Unlimited listings. All Pro features plus a dedicated account manager, full API access, custom reporting, and early feature access. Enterprise pricing is fixed and non-negotiable.</li></ul><p className="mt-2">Commission is deducted from each transaction before payout. Subscription fees are billed monthly via Stripe and are non-refundable except where required by applicable law. Optional add-on features (for example, additional storefront themes or custom branding beyond what your tier includes) may be offered for a separate one-time or recurring fee, disclosed at the point of purchase. The Platform reserves the right to adjust fee structures with 30 days notice.</p></section>
            <section><h3 className="text-base font-semibold text-gray-900 mb-2">5. Payouts</h3><p>Buyer payments are held on the Platform’s account, not transferred directly to Sellers at the time of sale. Once an order is confirmed delivered (via carrier tracking), the Seller’s share (sale price plus shipping and duties, minus commission) is released to the Seller’s connected Stripe account after a hold period:</p><ul><li><strong>New (probation) Sellers:</strong> 15 days after confirmed delivery.</li><li><strong>Trusted Sellers:</strong> 72 hours after confirmed delivery. A Seller becomes Trusted automatically once they have 10+ delivered orders, an account at least 30 days old, and no unresolved disputes or returns.</li></ul><p className="mt-2">If a return or dispute is opened on an order, that order’s payout is frozen until the return or dispute is resolved, regardless of the hold period above. Sellers must complete Stripe Connect onboarding to receive payouts; funds remain safely held on the Platform until onboarding is complete.</p></section>
