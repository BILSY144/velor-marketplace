    ...
    <div style={{ minHeight: '100vh', background: '#F6F6F7', fontFamily: 'Inter, sans-serif', padding: '48px 24px', color: '#1A1A1D' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={pStyle}>If a return or dispute is opened on an order, that order's payout is frozen until the return or dispute is resolved, regardless of the hold period above. Sellers must complete payout onboarding with the applicable provider (Stripe Connect, or Dots where applicable) to receive payouts; funds remain safely held on the Platform until onboarding is complete.</p>
          ...
          <p style={pStyle}>The Platform processes Seller personal data in accordance with its Privacy Policy, UK GDPR, and other data protection laws that apply given the Seller's location. Seller data is shared with Stripe Inc. - and with Dots where Dots is the Seller's payout provider - solely for processing transactions and payouts. Buyer shipping data must only be used for fulfilment.</p>
