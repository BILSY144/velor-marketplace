      ...
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={cardStyle}>
          ...
          <ul style={{ color: '#CCCCCC', fontSize: '14px', lineHeight: '1.7', margin: '8px 0', paddingLeft: '20px' }}>
            <li><strong style={{ color: '#FFFFFF' }}>Starter (Free):</strong> 12% commission on GMV. Maximum 20 active listings. Seller dashboard, analytics, and buyer protection on every sale.</li>
            ...
            <li><strong style={{ color: '#FFFFFF' }}>Enterprise (£99/month, fixed):</strong> 5% commission on GMV. Unlimited listings. All Pro features plus a dedicated account manager, full API access, a free custom storefront, custom reporting, and early feature access. Enterprise pricing is fixed and non-negotiable.</li>
          </ul>
