    ...
    <div style={{ minHeight: '100vh', background: '#F6F6F7', fontFamily: 'Inter, sans-serif', padding: '48px 24px', color: '#1A1A1D' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={pStyle}>The Platform charges a flat 10% commission on GMV on every sale, for every Seller. There is no paid subscription to lower this rate, and there are no listing fees or setup fees. Sellers on the free Starter plan may have up to 10 active listings at a time; Go Live live shopping, the seller dashboard, analytics, and buyer protection apply on every sale regardless. The Platform previously offered a paid "Pro" subscription tier at a reduced commission rate with unlimited listings; this self-serve tier has been retired and is no longer available for purchase. A small number of Sellers granted a lower rate before this tier was retired keep that previously-agreed rate; it is not available to new Sellers.</p>
          <p style={pStyle}>The first verified Seller from each country ("founding seller") instead keeps a permanent "Founding Seller" badge and priority placement in search and on their country's page, for as long as they keep selling -- granted automatically and free of charge, never purchased, but with no change to their commission rate.</p>
          <p style={pStyle}>Commission is deducted from each transaction before payout. Optional add-on features (for example, additional storefront themes or custom branding) may be offered for a separate one-time or recurring fee, disclosed at the point of purchase. The Platform reserves the right to adjust fee structures with 30 days notice.</p>
          ...
          <p style={pStyle}>The Platform processes Seller personal data in accordance with its Privacy Policy, UK GDPR, and other data protection laws that apply given the Seller's location. Seller data is shared with Stripe Inc. - and with Payoneer where Payoneer is the Seller's payout provider - solely for processing transactions and payouts. Buyer shipping data must only be used for fulfilment.</p>
