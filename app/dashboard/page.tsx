...
export default function DashboardOverview() {
  ...
  const [rail, setRail] = useState<'STRIPE' | 'TROLLEY' | 'DOTS' | 'PAYONEER' | null>(null);
  ...
  useEffect(() => {
    ...
    fetch('/api/seller/me')
      ...
      .then(async (d) => {
        ...
        const r: 'STRIPE' | 'TROLLEY' | 'DOTS' | 'PAYONEER' = d.payoutRail === 'TROLLEY' ? 'TROLLEY' : d.payoutRail === 'DOTS' ? 'DOTS' : d.payoutRail === 'PAYONEER' ? 'PAYONEER' : 'STRIPE';
        setRail(r);
        try {
          if (r === 'STRIPE') {
