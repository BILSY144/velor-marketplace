  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;700;800&family=Inter:wght@400;500;600&family=Playfair+Display:ital,wght@1,400;1,600&family=Fraunces:ital,wght@0,400;0,500;0,600;1,500&family=Caveat:wght@600&family=Abril+Fatface&display=swap"
          rel="stylesheet"
        />
        <script
