  ...
  return (
    <main style={{ background: 'var(--bg)', minHeight: '72vh', padding: '72px 20px' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: 16, lineHeight: 1.75, margin: '0 0 16px' }}>Need a hand? Email <a href='mailto:hello@velorglobalmarket.com' style={{ color: 'var(--accent)' }}>hello@velorglobalmarket.com</a>.</p>
      </div>
    </main>
  )
}
