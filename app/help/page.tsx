...
const FAQS: { category: string; blurb: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What does it cost?', a: 'Nothing to list — ever. You pay commission when you sell: 15% on the free Starter tier, 8% on Pro, 5% on Enterprise. The earnings calculator on the Sell page shows the honest maths for your numbers.' },
