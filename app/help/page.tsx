...
// are never faked; live broadcasting is open to every tier (2026-07-15).
...
const FAQS: { category: string; blurb: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Can any seller broadcast?', a: 'Yes — every verified seller can go on air on Velor Live, whatever their account. Founding sellers additionally keep a permanent founding badge and priority placement.' },
    ],
  },
  {
    category: 'Selling',
    ...
    items: [
      ...
      { q: 'What does it cost?', a: 'Nothing to list — ever. You pay a single flat 10% commission when you sell, the same rate for every seller. The earnings calculator on the Sell page shows the honest maths for your numbers.' },
      ...
      { q: 'What do founding sellers get?', a: 'The first verified seller from each country keeps a permanent founding badge and priority placement in search and on their country’s page, for as long as they keep selling — commission stays the same flat 10% every seller pays.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I contact Velor?', a: 'Use the contact page or email customerservice@velorglobalmarket.com — we reply within one business day.' },
    ],
  },
]
