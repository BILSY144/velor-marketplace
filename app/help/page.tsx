...
const FAQS: { category: string; blurb: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What do founding sellers get?', a: 'The first verified seller from each country keeps the full Pro tier free for life — unlimited listings, Go Live, the dedicated AI account manager — plus the permanent founding badge and the first store on their country’s page.' },
