    ...
    <main className="vrf">
      ...
      <div className="vrf-wrap">
        <section className="vrf-hero">
          ...
          <p>Velor Roots Foundation is our plan for something bigger than commission rates: a UK charity, independent from Velor Commerce Ltd but built alongside it, working to help artisan sellers get out of, and stay out of, homelessness.</p>
        </section>
        ...
        <section className="vrf-section">
          ...
          <ul className="vrf-list">
            ...
            <li><i>&#9679;</i><span>Support to Foundation-connected sellers means onboarding help, materials and photography support, and access to buyers worldwide — never a discount on Velor&rsquo;s standard commission. Every seller trades on the same flat rate; this is about opportunity, not charity pricing.</span></li>
