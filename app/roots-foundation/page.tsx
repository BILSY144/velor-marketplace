...
.vrf-hero {font-size:16.5px;color:var(--muted);line-height:1.65;max-width:56ch;margin:0 auto}
.vrf-section{padding:36px 0;border-top:1px solid var(--border)}
.vrf-section h2{font-size:23px;margin-bottom:14px}
.vrf-section {font-size:15px;color:var(--muted);line-height:1.7;margin:0 0 14px}
.vrf-section :last-child{margin-bottom:0}
...
.vrf-cta {font-size:13px;color:var(--muted);margin-top:20px}
.vrf-cta  a{text-decoration:underline;background:none;padding:0;margin:0;color:inherit;font-weight:400;font-size:inherit;display:inline}
`
    ...
    <main className="vrf">
      ...
      <div className="vrf-wrap">
        ...
        <section className="vrf-section">
          ...
          <p>We don’t think a marketplace and a charity have to be separate projects. Every sale on Velor already moves money to a real maker. Velor Roots Foundation is our plan to point some of that same energy — buyer generosity, seller opportunity — directly at ending homelessness for the people closest to our own mission.</p>
        </section>

        <section className="vrf-section">
          <h2>How it will work</h2>
          <ul className="vrf-list">
            <li><i>&#9679;</k><span>At checkout, buyers will be able to add a small optional donation — 20p, 50p or �1 — to Velor Roots Foundation. Entirely opt-in, never a default or a dark pattern.</span></li>
            <li><i>&#9679;</i><span>We’ll work with homelessness-focused social enterprises and individual makers experiencing or at risk of homelessness who want to sell their craft on Velor — opt-in recruitment, never a requirement to disclose anything they don’t want to.</span></li>
            <li><i>&#9679;</k><span>Support to Foundation-connected sellers means onboarding help, materials and photography support, and access to buyers worldwide — real opportunity, not charity pricing.</span></li>
        ...
        <section className="vrf-section">
          ...
          <p>Velor Roots Foundation is not yet registered as a charity, and the checkout donation feature is switched off until it is. We’d rather tell you plainly where things stand than oversell something that isn’t real yet — this page will be updated the moment that changes.</p>
        </section>
