...
return (
<Link key={a.id} href={`/pulse/applications/${a.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<ListCard>
...
{a.website && (
<div style={{ fontSize: 12, marginBottom: 2, color: PULSE.accent2 }}>
{a.website}
</div>
)}
