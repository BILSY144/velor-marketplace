      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          ...
          <AgreementSection num="6" title="Commission, Fees & Payouts">
            <ul>
              <li>Velor charges commission on the product subtotal of each completed sale based on your subscription tier: <strong style={{ color: '#FFFFFF' }}>Starter (free) 15%</strong>, <strong style={{ color: '#FFFFFF' }}>Pro (£49/month) 8%</strong>, <strong style={{ color: '#FFFFFF' }}>Enterprise (£199/month) 5%</strong>.</li>
