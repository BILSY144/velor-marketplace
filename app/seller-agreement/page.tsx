        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          ...
          <AgreementSection num="2" title="Seller Eligibility">
            <ul>
              ...
              <li>You must complete payout onboarding to receive payments: via Stripe Connect where Stripe supports payouts in your country, or via Payoneer where it does not. Your payout method is confirmed during onboarding.</li>
          ...
          <AgreementSection num="6" title="Commission, Fees & Payouts">
            <ul>
              <li>Velor charges a flat <strong style={{ color: '#FFFFFF' }}>10% commission</strong> on the product subtotal of every completed sale. There is no paid subscription to lower this rate, and it applies equally to every seller, including founding sellers. The first verified seller from each country instead keeps a permanent <strong style={{ color: '#FFFFFF' }}>&quot;Founding Seller&quot; badge and priority placement</strong> in search and on their country&apos;s page, for as long as they keep selling -- granted automatically and free of charge, never purchased, but with no change to their commission rate. (A small number of sellers granted a lower rate before this policy took effect keep that previously-agreed rate; it is not available to new sellers.)</li>
              ...
              <li>Velor does not charge listing fees or setup fees, and there are no paid tiers to subscribe to.</li>
