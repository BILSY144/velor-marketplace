      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          ...
          <AgreementSection num="6" title="Commission, Fees & Payouts">
            <ul>
              <li>Velor charges a flat <strong style={{ color: '#FFFFFF' }}>10% commission</strong> on the product subtotal of every completed sale. There is no paid subscription to lower this rate. The one exception is Velor's founding-seller programme: the first verified seller from each country keeps a <strong style={{ color: '#FFFFFF' }}>4% commission</strong> rate for as long as they keep selling, granted automatically and free of charge, never purchased.</li>
