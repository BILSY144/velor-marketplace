        ...
        {[
          {
            ...
            body: 'Velor Commerce Ltd ("Velor") is the data controller for personal data collected through the Velor platform. We are committed to protecting your privacy in accordance with UK GDPR and the Data Protection Act 2018.',
          },
          {
            title: '2. Data We Collect',
            body: 'We collect: (a) Account data — name, email address, password hash; (b) Transaction data — order details, shipping address, payment confirmation; (c) Seller data — business name, Stripe Connect account details; (d) Usage data — pages visited, device type, browser (via analytics); (e) Communications — messages sent via the platform.',
          },
          {
          ...
          },
          {
            ...
            body: 'Data protection enquiries: privacy@velorcommerce.store. If you are unhappy with how we handle your data, you may lodge a complaint with the Information Commissioner's Office (ico.org.uk).',
          },
        ].map(s => (
