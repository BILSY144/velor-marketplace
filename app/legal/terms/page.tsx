        ...
        {[
          {
            ...
            body: 'These Terms of Service ("Terms") govern your use of the Velor Commerce platform operated by Velor Commerce Ltd ("Velor", "we", "us"). By accessing or using Velor, you agree to be bound by these Terms.',
          },
          {
            title: '2. The Velor Platform',
            body: 'Velor is a multi-vendor marketplace that enables independent sellers ("Sellers") to list and sell products to buyers ("Buyers"). Velor acts as a platform intermediary and is not a party to transactions between Buyers and Sellers except where stated.',
          },
          {
            title: '3. Accounts',
