        ...
        <div>
          ...
          {product.avgRating != null && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px' }}>
              <span style={{ color: 'var(--accent)', fontSize: '16px' }}>{'\u2605'.repeat(Math.round(product.avgRating))}</span>
              <span style={{ color: 'var(--accent)', fontWeight: 600 }}>{product.avgRating}</span>
        ...
        {product.reviews.length > 0 && (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '16px', padding: '32px' }}>
            <h2 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '22px', fontWeight: 700, marginBottom: '24px' }}>
              Reviews
              {product.avgRating != null && (
                <span style={{ marginLeft: '12px', color: 'var(--accent)', fontSize: '18px' }}>{product.avgRating} \u2605</span>
              )}
            </h2>
