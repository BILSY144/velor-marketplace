...
// porcelain, Rugs/cloth & thread, The world's kitchen, Adornment & Jewellery, Tea/
...
const ETSY_TARGETS = [
  ...
  // Adornment & Jewellery
  { keywords: 'indian brass jewellery handmade artisan', category: 'Adornment & Jewellery' },
  { keywords: 'moroccan berber silver jewellery handmade', category: 'Adornment & Jewellery' },
  { keywords: 'peruvian silver filigree jewellery handmade', category: 'Adornment & Jewellery' },
  { keywords: 'turkish evil eye nazar jewellery handmade', category: 'Adornment & Jewellery' },
  { keywords: 'baltic amber jewellery handmade poland', category: 'Adornment & Jewellery' },
  { keywords: 'maasai beaded jewellery handmade kenya', category: 'Adornment & Jewellery' },
  { keywords: 'indian kundan jewellery handmade traditional', category: 'Adornment & Jewellery' },
  // Tea, coffee & pantry
...
const EBAY_TARGETS = [
  ...
  { query: 'indian brass jewelry handmade artisan', categoryId: '110633', category: 'Adornment & Jewellery' },
  { query: 'moroccan berber silver jewelry handmade', categoryId: '110633', category: 'Adornment & Jewellery' },
  { query: 'peruvian silver filigree jewelry handmade', categoryId: '110633', category: 'Adornment & Jewellery' },
  { query: 'turkish evil eye nazar jewelry handmade', categoryId: '110633', category: 'Adornment & Jewellery' },
  { query: 'baltic amber jewelry handmade poland', categoryId: '110633', category: 'Adornment & Jewellery' },
...
const GOOGLE_TARGETS = [
  ...
  // Adornment & Jewellery
  { query: 'indian brass jewellery artisan workshop shop buy', category: 'Adornment & Jewellery', market: 'in' },
  { query: 'moroccan berber silver jewellery artisan shop buy', category: 'Adornment & Jewellery', market: 'ma' },
  { query: 'peruvian silver filigree jewellery artisan shop buy', category: 'Adornment & Jewellery', market: 'pe' },
  { query: 'turkish evil eye jewellery artisan shop buy handmade', category: 'Adornment & Jewellery', market: 'tr' },
  { query: 'baltic amber jewellery artisan shop buy poland', category: 'Adornment & Jewellery', market: 'pl' },
  { query: 'maasai beadwork jewellery artisan shop buy kenya', category: 'Adornment & Jewellery', market: 'ke' },
  // Tea, coffee & pantry
  ...
  { query: 'artisan cooperative handmade export shop buy fair trade', category: 'Adornment & Jewellery', market: 'global' },
...
const BING_TARGETS = [
  ...
  { query: 'turkish evil eye jewellery artisan instagram shop buy', category: 'Adornment & Jewellery' },
  { query: 'peruvian silver filigree jewellery artisan instagram shop', category: 'Adornment & Jewellery' },
  ...
  { query: 'artisan jewellery handmade online store worldwide shipping origin', category: 'Adornment & Jewellery' },
  ...
  { query: 'ecuadorian panama hat weaver artisan shop buy online', category: 'Adornment & Jewellery' },
...
const BRAVE_CRAFTS: Array<{ craft: string; category: string }> = [
  ...
  // Adornment & Jewellery
  { craft: 'indian handmade jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'indian kundan jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'moroccan berber silver jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'peruvian silver filigree jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'kenyan maasai beaded jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'turkish evil eye jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'polish baltic amber jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'mexican oaxacan silver jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'balinese silver jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'ethiopian telsum jewellery artisan', category: 'Adornment & Jewellery' },
  { craft: 'ecuadorian panama hat weaver', category: 'Adornment & Jewellery' },
  { craft: 'vietnamese buffalo horn jewellery artisan', category: 'Adornment & Jewellery' },
  // Tea, coffee & pantry
  ...
  { craft: 'british silversmith jewellery studio', category: 'Adornment & Jewellery' },
  { craft: 'american handmade jewelry silversmith studio', category: 'Adornment & Jewellery' },
  { craft: 'australian handmade jewellery studio', category: 'Adornment & Jewellery' },
  { craft: 'canadian goldsmith handmade studio', category: 'Adornment & Jewellery' },
  { craft: 'italian murano glass jewellery artisan', category: 'Adornment & Jewellery' },
...
const BRAVE_MULTIPLIER_TARGETS: Array<{ query: string; category: string }> = [
  ...
  { query: 'indian handicraft artisans cooperative society', category: 'Adornment & Jewellery' },
  { query: 'kenyan artisan cooperative beadwork fair trade', category: 'Adornment & Jewellery' },
  ...
  { query: 'fair trade federation artisan member organization handmade', category: 'Adornment & Jewellery' },
  { query: 'artisan association handmade jewellery members shop', category: 'Adornment & Jewellery' },
