...
interface SellerGroup {
    ...
    items: { productId: string; variantId: string | null; quantity: number; priceGBP: number; originCountry: string | null; weightGrams: number | null }[]
    subtotalGBP: number
}
  ...
  try {
      ...
      let grandSubtotalGBP = 0
        ...
        const discountIds: string[] = []
          ...
          // the same approach used at quote time.
