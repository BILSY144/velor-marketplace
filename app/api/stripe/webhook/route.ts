...
const FROM_EMAIL = 'Velor Marketplace <customerservice@velorglobalmarket.com>';
  ...
  switch (event.type) {
    ...
    case 'customer.subscription.updated': {
      ...
      await prisma.seller.updateMany({
        ...
        data: {
          tier: 'PRO' as any, // Enterprise retired 2026-07-15 — every paid subscription is Pro
    ...
    case 'customer.subscription.deleted': {
      ...
      for (const s of downgraded) {
        ...
        if (live.length > 10) { // Starter cap lowered 20 -> 10 (William, 2026-07-15)
          const excess = live.slice(10);
