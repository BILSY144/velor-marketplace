...
function SellerChannel() {
  ...
  const studio: {
    ...
    },
    {
      ...
      route: 'SellerQuestions',
    },
    {
      icon: 'pricetag-outline',
      title: 'Discounts',
      sub: 'Codes that apply themselves at your buyers’ checkout',
      route: 'Discounts',
    },
    {
      icon: 'refresh-outline',
      title: 'Returns',
      sub: 'Approve or decline return requests',
      route: 'Returns',
    },
    {
      icon: 'people-outline',
      title: 'Followers',
      sub: 'Everyone following your channel',
      route: 'Followers',
    },
    {
      icon: 'boat-outline',
      title: 'Shipping',
      sub: 'Free by default — or set your own flat rate',
      route: 'ShippingSettings',
    },
    {
      icon: 'help-buoy-outline',
      title: 'Support',
      sub: 'Open a ticket with the Velor team',
      route: 'Support',
    },
    {
      icon: 'key-outline',
      title: 'API keys',
      sub: pro ? 'Connect your own tools to your store' : 'Legacy Pro tool',
      route: 'ApiKeys',
      locked: !pro,
    },
  ]
