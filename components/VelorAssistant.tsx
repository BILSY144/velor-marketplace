'use client'
  ...
  import { useState, useRef, useEffect } from 'react'
    ...
    const I18N: Record<string, Locale> = {
      en: { buyerGreeting: "Hi, I'm Velor's AI Assistant. I'm here to help you shop with confidence — how our buyer protection works, tracking an order, returns and disputes, or finding something from our sellers around the world.", placeholder: 'Ask about buyer protection, orders, returns...', hint: '' },
      es: { buyerGreeting: 'Hola, soy la asistente de IA de Velor. Estoy aquí para ayudarte a comprar con confianza: cómo funciona nuestra protección al comprador, el seguimiento de un pedido, devoluciones y disputas, o encontrar algo de nuestros vendedores de todo el mundo.', placeholder: 'Pregunta sobre protección, pedidos, devoluciones...', hint: 'Puedes escribirme en tu propio idioma.' },
      fr: { buyerGreeting: "Bonjour, je suis l'assistante IA de Velor. Je suis là pour vous aider à acheter en toute confiance : le fonctionnement de notre protection acheteur, le suivi d'une commande, les retours et litiges, ou trouver un article chez nos vendeurs du monde entier.", placeholder: 'Protection acheteur, commandes, retours...', hint: 'Vous pouvez m’écrire dans votre propre langue.' },
      de: { buyerGreeting: 'Hallo, ich bin die KI-Assistentin von Velor. Ich helfe Ihnen, mit Vertrauen einzukaufen: wie unser Käuferschutz funktioniert, Sendungsverfolgung, Rückgaben und Streitfälle, oder etwas bei unseren Verkäufern weltweit zu finden.', placeholder: 'Käuferschutz, Bestellungen, Rückgaben...', hint: 'Sie können mir in Ihrer eigenen Sprache schreiben.' },
      it: { buyerGreeting: 'Ciao, sono l’assistente IA di Velor. Sono qui per aiutarti ad acquistare in tutta sicurezza: come funziona la protezione acquirenti, il tracciamento di un ordine, resi e controversie, o trovare qualcosa dai nostri venditori in tutto il mondo.', placeholder: 'Protezione acquirenti, ordini, resi...', hint: 'Puoi scrivermi nella tua lingua.' },
      pt: { buyerGreeting: 'Olá, sou a assistente de IA da Velor. Estou aqui para te ajudar a comprar com confiança: como funciona a nossa proteção ao comprador, seguimento de encomendas, devoluções e disputas, ou encontrar algo dos nossos vendedores em todo o mundo.', placeholder: 'Proteção, encomendas, devoluções...', hint: 'Podes escrever-me no teu próprio idioma.' },
      nl: { buyerGreeting: 'Hallo, ik ben de AI-assistent van Velor. Ik help je met vertrouwen te winkelen: hoe onze kopersbescherming werkt, een bestelling volgen, retouren en geschillen, of iets vinden bij onze verkopers wereldwijd.', placeholder: 'Kopersbescherming, bestellingen, retouren...', hint: 'Je mag me in je eigen taal schrijven.' },
      pl: { buyerGreeting: 'Cześć, jestem asystentką AI Velor. Pomogę Ci kupować z pewnością: jak działa ochrona kupującego, śledzenie zamówienia, zwroty i spory, albo znalezienie czegoś u naszych sprzedawców z całego świata.', placeholder: 'Ochrona kupującego, zamówienia, zwroty...', hint: 'Możesz pisać do mnie w swoim języku.' },
      tr: { buyerGreeting: 'Merhaba, ben Velor’un yapay zeka asistanıyım. Güvenle alışveriş etmenize yardımcı olmak için buradayım: alıcı korumamızın nasıl çalıştığı, sipariş takibi, iadeler ve anlaşmazlıklar veya dünyanın her yerinden satıcılarımızdan bir şey bulmak.', placeholder: 'Alıcı koruması, siparişler, iadeler...', hint: 'Bana kendi dilinizde yazabilirsiniz.' },
      ru: { buyerGreeting: 'Здравствуйте, я ИИ-ассистент Velor. Я помогу вам покупать с уверенностью: как работает защита покупателя, отслеживание заказа, возвраты и споры, или как найти что-то у наших продавцов по всему миру.', placeholder: 'Защита покупателя, заказы, возвраты...', hint: 'Вы можете писать мне на своём языке.' },
      ar: { buyerGreeting: 'مرحباً، أنا المساعدة الذكية في فيلور. أنا هنا لمساعدتك على التسوق بثقة: كيف تعمل حماية المشتري، تتبع الطلب، الإرجاع والنزاعات، أو العثور على شيء من بائعينا حول العالم.', placeholder: 'حماية المشتري، الطلبات، الإرجاع...', hint: 'يمكنك مراسلتي بلغتك الخاصة.' },
      hi: { buyerGreeting: 'नमस्ते, मैं Velor की AI सहायक हूँ। मैं आपको भरोसे के साथ खरीदारी करने में मदद करने के लिए यहाँ हूँ: हमारी खरीदार सुरक्षा कैसे काम करती है, ऑर्डर ट्रैक करना, वापसी और विवाद, या दुनिया भर के हमारे विक्रेताओं से कुछ ढूँढना।', placeholder: 'खरीदार सुरक्षा, ऑर्डर, वापसी...', hint: 'आप मुझे अपनी भाषा में लिख सकते हैं।' },
      bn: { buyerGreeting: 'নমস্কার, আমি Velor-এর AI সহকারী। আমি আপনাকে নিশ্চিন্তে কেনাকাটা করতে সাহায্য করতে এখানে আছি: আমাদের ক্রেতা সুরক্ষা কীভাবে কাজ করে, অর্ডার ট্র্যাক করা, ফেরত ও বিরোধ, অথবা সারা বিশ্বের বিক্রেতাদের কাছ থেকে কিছু খুঁজে পাওয়া।', placeholder: 'ক্রেতা সুরক্ষা, অর্ডার, ফেরত...', hint: 'আপনি আমাকে আপনার নিজের ভাষায় লিখতে পারেন।' },
      vi: { buyerGreeting: 'Xin chào, tôi là trợ lý AI của Velor. Tôi ở đây để giúp bạn mua sắm yên tâm: cách bảo vệ người mua hoạt động, theo dõi đơn hàng, đổi trả và khiếu nại, hoặc tìm thứ gì đó từ những người bán của chúng tôi trên khắp thế giới.', placeholder: 'Bảo vệ người mua, đơn hàng, đổi trả...', hint: 'Bạn có thể nhắn cho tôi bằng ngôn ngữ của bạn.' },
      th: { buyerGreeting: 'สวัสดีค่ะ ฉันคือผู้ช่วย AI ของ Velor ฉันอยู่ที่นี่เพื่อช่วยให้คุณช้อปอย่างมั่นใจ: การคุ้มครองผู้ซื้อทำงานอย่างไร การติดตามคำสั่งซื้อ การคืนสินค้าและข้อพิพาท หรือค้นหาสินค้าจากผู้ขายของเราทั่วโลก', placeholder: 'การคุ้มครองผู้ซื้อ คำสั่งซื้อ การคืนสินค้า...', hint: 'คุณเขียนถึงฉันเป็นภาษาของคุณได้เลย' },
      id: { buyerGreeting: 'Halo, saya asisten AI Velor. Saya di sini untuk membantu Anda berbelanja dengan tenang: cara kerja perlindungan pembeli, melacak pesanan, pengembalian dan sengketa, atau menemukan sesuatu dari penjual kami di seluruh dunia.', placeholder: 'Perlindungan pembeli, pesanan, pengembalian...', hint: 'Anda boleh menulis kepada saya dalam bahasa Anda sendiri.' },
      zh: { buyerGreeting: '您好，我是 Velor 的 AI 助理。我可以帮助您放心购物：买家保护如何运作、订单追踪、退货与争议，或从我们世界各地的卖家中找到您想要的商品。', placeholder: '买家保护、订单、退货……', hint: '您可以用自己的语言与我交流。' },
      ja: { buyerGreeting: 'こんにちは、Velor の AI アシスタントです。安心してお買い物いただけるようお手伝いします。購入者保護の仕組み、注文の追跡、返品や紛争、または世界中の出品者からの商品探しについてお尋ねください。', placeholder: '購入者保護、注文、返品について...', hint: 'ご自身の言語で書いていただけます。' },
      ko: { buyerGreeting: '안녕하세요, Velor의 AI 어시스턴트입니다. 안심하고 쇼핑하실 수 있도록 도와드립니다: 구매자 보호가 작동하는 방식, 주문 추적, 반품 및 분쟁, 또는 전 세계 판매자로부터 원하는 상품 찾기.', placeholder: '구매자 보호, 주문, 반품...', hint: '원하시는 언어로 편하게 적어 주세요.' },
    }
