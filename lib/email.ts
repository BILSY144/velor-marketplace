...
const FROM = 'Velor Commerce <hello@velorglobalmarket.com>';
const REPLY_TO = 'customerservice@velorglobalmarket.com';
...
export function buildSellerRejectedEmail(d: {
  ...
  const html = `${WRAP_OPEN}
    ...
    <p style="color:#777;font-size:13px;line-height:1.6">
      If you believe this decision was made in error, or if your circumstances have changed, please contact us at customerservice@velorglobalmarket.com.
    </p>
    ${WRAP_CLOSE}`;
