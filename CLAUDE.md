# FIRST TASK NEXT SESSION -- NON-NEGOTIABLE (William, 2026-07-29, verbatim gist: "it must be the first thing completed when i arrive to the next session. no ifs or buts... thats a rule. i dont wanna mess with taxes")
...
## LAUNCH DATE FLAG (William, 2026-07-29, verbatim gist: "on the 6th of august opening to buyers is looking like its off the shelf at the moment as theres nothing to buy... a working progress")
