...
- Imagery: sourcing real, visually-verified Pexels photos per country, region by region ("cannot get this wrong" — wrong ones stay as honest "Opening soon" placeholders, never a wrong photo). **Waves 1-7 DONE & pushed** (~900 verified photos; 139 countries). Waves 8+ pending: East/Central/Southern Africa (~28), North America + Oceania (~16). Method + remaining waves in the checkpoint doc; picks in docs/app-mockup/wave1_picks.py.
