...
6. Standing directive still applies: do not change anything without explicit user permission -- this is a planning/discovery task list only, no code has been touched yet.
