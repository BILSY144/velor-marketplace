...
- Prereq #2 OSA PAPERWORK: DRAFTED -- docs/osa/ holds four documents (illegal-content risk assessment per Ofcom's 17 kinds of harm with fraud rated Medium as the marketplace's real risk; children's access assessment concluding child-user condition NOT met with re-review dates incl. buyer-launch+3mo 2026-11-06; online safety policy naming William as compliance owner + the pre-social-launch BUILD LIST: report buttons on ALL UGC incl. reviews+messages, public /safety page usable by non-users, appeals route, block/mute, new-account rate limits; DPIA for the social layer). ALL marked DRAFT with sign-off blocks -- NOT adopted until William signs. Delivered to him as velor-osa-compliance-pack.pdf (10pp A4) for printing. Assessments deliberately cover EXISTING U2U surfaces (reviews, messaging, live chat, listings), not just the future feed.
