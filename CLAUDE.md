...
**William immediately continued to Step 3 in the same message thread reporting a new, similar bug in the "Founding Seller Benefits" box (a "Smart tools" badge overlapping the card's left/right borders and not sitting inline with its siblings) -- investigation for that is picked up separately below / next in this log.**
