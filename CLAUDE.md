...
- Imagery: sourcing real, visually-verified Pexels photos per country, region by region ("cannot get this wrong" — wrong ones stay as honest "Opening soon" placeholders, never a wrong photo). **Waves 1-5 DONE & pushed** (LatAm 156, E/SE Asia 102, S/C Asia+Caucasus 83, Middle East 65, W/S/C Europe 116 photos; 93 countries). Waves 6+ pending: E Europe/Nordic/Baltic/Balkans, Africa, N.America+Oceania. Method + remaining waves in the checkpoint doc; picks in docs/app-mockup/wave1_picks.py.
