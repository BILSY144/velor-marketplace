...
RULES FOR EVERY SESSION: (1) At session start, TELL William the current state in 2-3 plain sentences (dyslexia-friendly, short) -- NEVER ask him to explain where things stand. (2) Update THIS dashboard at every checkpoint -- move items between sections; the long history below is archive, this is the truth. (3) A stale dashboard is a LAW #1 violation. (4) CANONICAL TIER FACTS (verify at /sell + the header note of docs/SUBSCRIPTION_AND_TIERS.md before EVER quoting tiers to anyone): TWO tiers only since 2026-07-15 -- Starter Free / 10% commission / 10-listing cap, Pro GBP 49/mo / 4% commission / unlimited + all former Enterprise features; Enterprise is RETIRED; Velor Live is on every tier; the founding offer is Pro FREE FOR LIFE for the FIRST verified seller from each country (a per-country seat, not everyone who lists early). The old 15/8/5 three-tier table still printed lower in the tiers doc is HISTORY -- never quote it. (5) NEVER read repo files via raw.githubusercontent.com/BILSY144/velor-marketplace/main/... -- the CDN serves WEEKS-STALE copies (2026-07-29: a main-URL fetch returned the 2026-07-04 CLAUDE.md and stale tier rates nearly went to a seller lead; William caught it). ALWAYS resolve the HEAD commit SHA first (git/refs/heads/main) and fetch pinned to that SHA.
...
- ECOMCONNECT 50-MAKER DM CAMPAIGN (William, 2026-07-29 very late, IN PROGRESS -- runs EVERY OTHER DAY until 50 handcraft makers/artisans invited): message template has NO PRICES (his rule) -- offer only: real-makers marketplace, follows/journal audience they keep, weekly Fresh-from-the-Workshop drop, founding place with the full professional plan free for life, escrow, Stripe/Payoneer payouts, self-arranged shipping. METHOD (proven): ecomconnect.org/people?industry_ids=[8] (Arts and Crafts filter) -> click member card -> Send message in the preview panel -> type personalised message (name + country) -> send. SENT SO FAR (16/50, 2026-07-29): SARA DIPEPA (Cameroon), Pauline Kariuki (Kenya), Blessing Ebere Achu (Nigeria), Chomnab Ho (Cambodia), Xiomara Valverde (Costa Rica), Ismat Khan (Bangladesh), Atef Helal najar (Tunisia), ASMAA BENACHIR (Morocco), Gabish Joshi (Philippines), Nipuni Munasinghe (Sri Lanka), Vaishali Sawant (India), Talant T (Kyrgyzstan), Kamran Niazi (Pakistan), Edward Dwamena kay (Ghana), Milagro de Mena (El Salvador), Ndeye Khar NDAO (Senegal). NEXT CANDIDATES (all Arts-and-Crafts industry, uncontacted): Omina Otsieno (Kenya), Geraldine Duran Galvez (Costa Rica), Sarah M (Kenya), Gabish Joshi (Philippines), Gloria Yesenia Arevalo Linares (El Salvador), Rosalba Ramos (Honduras), Nipuni Munasinghe (Sri Lanka), Vaishali Sawant (India), Talant T (Kyrgyzstan), Rebeca Zamora Fallas (Costa Rica), Kamran Niazi (Pakistan), Edward Dwamena kay (Ghana), Milagro de Mena (El Salvador), Nana Abena Boatemaa (Ghana), Ndeye Khar NDAO (Senegal), issaoui hela (Tunisia), Gus Wood (Indonesia), Hana Sarra Fedjkhi (Algeria), Loddys Molina (Guatemala), Jihene Barnat (Tunisia), Marcela Sibaja Guillen (Costa Rica), Ajo Balogun (Nigeria), Perpetua Waeni (Kenya), We am Zeidan (Jordan), Luzmina JALIL Barria (Panama), Mojibur Rahman Shymal (Bangladesh), Evelyn Rivera (Honduras), Mohamed El baqqaly (Morocco), Mira Tb (Tunisia), Temilola Joseph (Nigeria), Geraldine Aguilar Flores (Nicaragua), Oluwatomi Reuben (Nigeria), jacinta gichukia (Kenya), Runa Rahman (Bangladesh), Astrid ARAUZ (Panama), Rania Kinge (Switzerland), Brenda Maria Moraga Ordonez (Nicaragua). Already contacted, NEVER re-message: christine masese, Daphne Kasambala, Kennedy Mahr, Kanika Sahijwani, Jeneale Downer, Marie Sia Kamara, Asma Hamrouni, Meta Dharmawan, Israel Fugah, BaSE. Cadence guard: stay near 40 contacts/week. ALSO SENT same night: drop-invite emails to all 4 live sellers (Eastern Wisdom, LAKA, PetLuv, hushlume x2 addresses) for the Thu 18:00 UTC first drop.
- OUTREACH IS LIVE (2026-07-29 ~18:5x UTC): William had Claude flip OUTREACH_ENABLED to true in Vercel (Production+Preview) and redeploy. The automated email pipeline now sends, gated to label+Stripe countries with the 40/week cap (see next item). Monitor via the BCC to the monitoring address + the daily briefing.
- STANDING RULE -- SELLERS OUTSIDE LABEL GENERATION (William, 2026-07-29, verbatim gist: "anyone outside of label generation will need to reflect their prices into the total and offer free shipping ok"): every seller in a country Velor cannot buy labels for must bake real postage into the product price and set FREE shipping in Settings -> Shipping, so checkout shows FREE and no platform shipping estimate scares buyers. Tell every such seller this at recruitment/onboarding. Eastern Wisdom is the model; PetLuv/hushlume/LAKA instructed 2026-07-29.
- ECOMCONNECT DM SCOUTING (William, 2026-07-29): CONTINUES for ALL countries, ~40 contacts/week across two weekly sessions -- non-label-country sellers are still wanted; they self-ship under the standing rule above (Payoneer payouts where Stripe unavailable). Needs William's browser (Hivebrite session), so it stays a manual twice-weekly session activity, unlike the fully automatic email pipeline.
...
- 2026-07-29 (~17:xx UTC) CHECKPOINT: inbox swept + replies sent. EASYSHIP: Joseph (Enterprise) answered -- pre-negotiated rates cover ONLY 11 origins (GB/US/CA/AU/FR/DE/NL/BE/HK/SG/NZ), NO mainland China (matches our earlier finding); replied same day (William-approved): not a deal breaker, China handled separately, send the written Enterprise proposal for the 11 origins -- now AWAITING the proposal. CN-SELLER FREE-SHIPPING CAMPAIGN (William's rule: any seller we cannot label for must bake postage into price + set FREE shipping in dashboard, temporary until non-covered-origin shipping exists): live catalogue checked (9 listings, 4 sellers, all CN) -- Eastern Wisdom already FREE (done); bilingual EN/CN instruction emails sent to PetLuv Magic (youyou_yuchen1@126.com, ~44.69 estimate), hushlume (BOTH addresses 17580690095@163.com + hello@gethushlume.com, ~72.10), LAKA's Studio (jiweize7@gmail.com -- NEW 4th live seller, first listing 2026-07-29, warm reply from Ji WeiZe asking about platform authenticity + founder vision; answered personally incl. the shipping instruction). WATCH for all three to flip their Settings->Shipping to FREE; nudge in a few days if not. SELLER LEADS from Hivebrite community: Kanika Sahijwani (2026-07-29 11:46) ASKING ABOUT COMMISSION -- warm lead, reply must go via the Hivebrite platform (NOT email), STILL PENDING; Jeneale Downer declined politely (logged, no action). Apple case: William's Devara reply sent overnight, no answer yet.
...
- Launch date: PARTLY DECIDED 2026-07-29 -- William ordered the 6 Aug date REMOVED from all public copy (done, commit 6ec7609: all surfaces now say "in the coming weeks"; /sell countdown timer deleted). Still open: the actual new launch date; Play Store data-safety answers still say 6 Aug (Play Console only -- APP DAY item); OSA buyer-launch+3mo re-review anchor moves once a date exists.
...
## LAUNCH DATE FLAG -- ACTIONED 2026-07-29, commit 6ec7609 (William: "remove the 6th of august launch as its not looking good for seller sign ups"): the hard date is GONE from /apply, /founding, /mission, /press (stat card + boilerplate), /sell (countdown timer removed entirely), shop banner, llms.txt, and both outreach template files -- all now say "in the coming weeks". Internal logs untouched (they are records). STILL OPEN: no new date chosen; Play Store data-safety answers (Play Console, APP DAY); Asha/WFTO/EPCH got the old date in their follow-up -- correct gently in any reply thread. Original flag kept below for the record. (Original: William, 2026-07-29, verbatim gist: "on the 6th of august opening to buyers is looking like its off the shelf at the moment as theres nothing to buy... a working progress")

The 6 AUGUST buyer launch is LIKELY SLIPPING -- William's call, because the catalogue is still nearly empty. NO formal new date has been set, and the SITE/PRESS/APP COPY ALL STILL SAY 6 AUGUST (homepage, /sell, press release, Play Store answers, prior outreach). DO NOT change any public copy without William's explicit decision on a new date -- but RAISE THIS with him at the next session start: if the date moves, the site copy, the press release follow-ups, the Play data-safety answers, and the buyer-launch+3mo OSA re-review anchor (2026-11-06) all need a coordinated update. Outreach wording shifted mid-send on his instruction: emails now say "opens to buyers in the coming weeks" instead of the hard date.

## FOLLOW-UP WAVE SENT 2026-07-29 (~11:0x-11:3x UTC), William approved "send all 18"

All 18 follow-ups sent from william@velorcommerce.co.uk (Graph API sends -- note the connector caps sends at 5 per 5 minutes; pace future batches). New hooks used: buyers arriving soon + the Maker Journal/Workshop Feed launch ("no other marketplace gives small makers this"). HONESTY NOTE: the first 3 (Asha cc Ivan Carvalho, WFTO, EPCH head office) went out saying "Buyers open on 6 August -- next week" BEFORE William flagged the date slipping; the remaining 15 say "in the coming weeks" (his approved rewording). If a new date is set, Asha/WFTO/EPCH may need a gentle correction in any reply thread.
- 6 organisations: Asha Handicrafts, WFTO, EPCH, WCC Asia-Pacific, RajSICO, FTF-India (both addresses)
- 12 EPCH makers (all with personal salutations recovered from Sent Items): Mr Maurya (10 Fingers, info@10fingers.co.in), Mr Budhia (A B Carpet & Durries, abcdurries@gmail.com), Mr Naqash (Akbar Art Gallery, parveezakbar@gmail.com), Mr Hasan (A L Paper House, hasan@alpaperhouse.com), Mr Ajmal (Ajmal Handicrafts, ajmalcraft@gmail.com), Mr Siddiqui (2 S Collection, shariq@2scollection.com), Mr Hasan (A.H. Decorative, info@ahdecorative.com), Mr Bhawalpuria (A. M. Glass, amglass@amglassintl.com), Mr Singhal (Ajay Glass Works, info@ajayglassworks.com), Mr Mallick (A M Leather, info@amleatherindia.com), Mr Jeganathan (A S K Hometex, jegan@askhometex.com), Mr Agarwal (Akrati Jewels, akratijewelsinc@gmail.com)
- DISCOVERED IN SENT ITEMS, previously UNLOGGED: a large direct-maker wave went out 22 Jul evening ("<Country>'s founding seat -- offered to its best makers, first to accept takes it") to ~17 makers across Mexico (Uriarte Talavera, Cooperativa 1050), Tunisia (Lunja, Sadika, L'Artisan by Kerkeni), Peru (Awamaki, Romani Art), Kenya (Ocean Sole), Ghana (Aketekete, Trashy Bags, Selina Beb), Indonesia (Tulola, PALA Nusantara), Bangladesh (Tangail Saree Kutir, Clay Image/Rehana, Tonni), India (Slow Pottery/Nikita, Quirksmith/Divya+Pragya). ALL silent so far -- they are follow-up candidates for the same two-hook email; NOT yet sent (William approved only the 18). Ask him next session.
...
| 10 | CN platform-default rate recalibration (honest Tier B pricing until #8 lands) | **FIRST SELLER ACTED 2026-07-29 (~12:2x UTC, spotted live by William): The Eastern Wisdom set their international flat rate to GBP 0.00 (free shipping, seller pays postage) -- their PDP estimate dropped from GBP 44.69 to GBP 1.20 (just the per-item admin fee), proving the whole chain: outreach email -> seller self-serve settings -> ShippingEstimate cache purge -> live PDP update. No email reply; they just did it. CAUTION: 0.00 may be deliberate (shipping baked into goods price, common for CN sellers) or a mistyped field -- a short bilingual (EN/CN) confirmation note was SENT 2026-07-29 ~12:4x UTC (William approved) from william@velorcommerce.co.uk: confirms 0.00 means buyer pays no shipping and the seller covers postage, clarifies the 1.20 buyers see is Velor's buyer-paid handling fee, and points to Settings -> Shipping to change it. Watch for their reply. PetLuv Magic (44.69) and hushlume (72.10) have NOT acted yet -- nudge in a few days if still silent.** Original action log: 3 real mainland-CN sellers emailed 2026-07-29 ~03:1x UTC The new PDP delivery estimate made the problem buyer-visible (~GBP 44.69 CN->GB/US shown on live listings), so per William ("this is why we need to set up the global shipping this is attrocious") the 3 real mainland-CN sellers with live listings were emailed from william@velorcommerce.co.uk (bilingual EN/CN, William-approved wording incl. his "temporary measure, our own system is coming shortly" reassurance): The Eastern Wisdom (tianyishui16@outlook.com), hushlume (both addresses -- same person, two accounts), PetLuv Magic (youyou_yuchen1@126.com). Ask: set Settings->Shipping "International flat rate (GBP)" to their real tracked-economy cost; that tier OVERRIDES the platform default at PDP + checkout instantly (shipping-settings save now also purges the seller's ShippingEstimate cache rows, commit e4fd33a). NOTE: 4th live-listing CN seller "hollows" is WILLIAM'S OWN test store (contact willsinclair144@gmail.com) -- not emailed; he sets it himself. WATCH for seller replies + whether flat rates appear; platform-default table recalibration still open if sellers don't act. | inbox checked ~02:5x UTC: no YunExpress or Easyship-enterprise reply yet |
...
SELLER-PROVIDED SHIPPING IS FEE-FREE (WILLIAM'S RULE, 2026-07-29 ~13:0x UTC, commit 8060c4f, LIVE-VERIFIED): "if they provide the shipping, we do not charge the 1.20 admin fee" -- applyAdminFee (rates route) AND the payment-intent fee block BOTH skip the seller-flat-rate tier now; the GBP1.20/item fee applies ONLY where Velor arranges the price (live carrier quotes + platform-default tier). Settings -> Shipping gained a three-way pricing chooser per his ask ("a button in dashboard so seller can put free shipping"): Velor sets the price (blank/null) / FREE shipping one-tap (writes 0) / My own flat rate (reveals input) -- honest who-pays-what copy. PDP estimate line now renders "FREE shipping from the seller" (green) for free, "seller's shipping rate X" (no 'est.') for seller-set, unchanged estimate wording for Velor-priced lanes; estimate API returns sellerSet/freeShipping flags on every response path. New admin route POST /api/admin/purge-shipping-estimates (Bearer ADMIN_SECRET, {sellerSetOnly:true} option) -- RUN 2026-07-29 (purged 4 fee-stale rows); Door God PDP live-verified showing "FREE shipping from the seller", estimate API amountGBP 0. NOTE: the earlier confirmation email to The Eastern Wisdom mentioned the 1.20 buyer fee -- now removed for them; a one-line update email was offered to William. William on the seller: "i like this seller, so cooperative" -- strong Founding Makers candidate for China.

CHECKOUT SHIPPING CHAIN COMPLETED + KLARNA CONFIRMATION-PAGE BUG (2026-07-29 ~13:3x-14:3x UTC, commits e44bb40 / bf79301 / b8a6c8a, all live-verified): three fixes in direct response to William testing the Door God checkout live. (1) e44bb40 -- checkout AUTO-FETCHES shipping rates (debounced 800ms on address completeness); the "Get Shipping Rates" button is GONE (William: "the seller has set free shipping, so that shouldnt be visible"); seller-flat-rate 0.00 rows render "FREE shipping -- provided by the seller" with green FREE (compare with Number(rate.amount) -- it is a number here, parseFloat broke the build 3x). (2) bf79301 -- THE TIER-ORDER FIX: live Shippo quotes were OUTRANKING the seller's free flat rate (PDP said FREE, checkout charged 24.31 -- Shippo's CN express quote). Rule now: on an international lane whose origin is NOT auto-label capable (not GB/DE/CA and not an easyshipRateOrigins() member), a seller-set internationalFlatRateGBP REPLACES live quotes entirely -- the seller's price is the price. Auto-label origins keep live quotes (a real label must be purchasable). API-verified: The Eastern Wisdom rates now return exactly one option, seller-flat-rate 0.00. LIVE PROOF FROM A REAL PAYMENT ATTEMPT: William's Klarna attempt pi_3TyNyaDB5eA3Wfmu1Rvm8TSu carried the CORRECT metadata -- shippingGBP 0.00, duties 1.35, total 8.12 (item 6.77) -- the whole chain priced right at real checkout. (3) The attempt FAILED because William cancelled the Klarna page mid-flow ("Customer cancelled checkout on Klarna", zero charged) -- and the confirmation page STILL showed "Order Confirmed!" and emptied his basket (William: "not good for buyer who cancelled then shows a order confirmation page"). Server was already safe (POST /api/orders 409s unless pi.status succeeded; webhook fires only on success; NO order row existed -- his My Orders correctly empty). Fixed in b8a6c8a: redirect_status=failed (and 409 responses) now render an honest "Payment not completed -- no money was taken" page, cart KEPT for retry, Return-to-Checkout CTA. STILL UNOBSERVED: a completed real order on the free-shipping lane -- William got as far as the Klarna cancel; a card payment at 8.12 would be the first real seller-provided-free-shipping order (CN->GB) end to end.

VAT ROUTE BUILT (William, 2026-07-29: "we need to set up the vat route and it goes to a seperate pot") + PRICE-RULE SWEEP COMPLETED (commits 8aa2750 / 1886dcd / d4a2985 / db1ab38, all READY): (1) William asked where the checkout "Duties & taxes" money goes -- code inspection showed it was passed to the SELLER commission-free. For CN->GB that money is really 20% UK VAT, and under HMRC's deemed-supplier rules (imports <= GBP 135 sold via an OMP) VELOR owes that VAT to HMRC, not the seller. Full position paper: docs/VAT-OMP-POSITION.md (registration question, HMRC Jun-Aug 2026 consultation extending deemed-supplier to UK sellers, planned removal of the GBP 135 duty exemption -- NOT tax advice, accountant must confirm before buyer launch; William to arrange). (2) db1ab38 implements the pot: on deemed-supplier lanes (origin != GB, destination GB, discounted goods subtotal <= 135) the tax is EXCLUDED from sellerEarnings and platformFee and lands in new Order.vatCollected (additive field, applied by deploy's db push) -- payout cron follows automatically since it reads the e share. Other lanes (> 135 / non-UK dest) keep pass-through for duties-paid shipping. Buyer price unchanged -- the tax line already IS the 20%; registering changes where it goes, not what buyers pay. (3) Two more PRICE-DISPLAY RULE violations found by William the same hour: the order snapshot stored raw seller-currency prices (the $9.00 print rendered "GBP 9.00" beside a 6.77 subtotal -- fixed 8aa2750, converts at write time) and the landed-cost quote declared the raw $9.00 as GBP 9.00, over-quoting duty 1.80 vs the real 1.35 charge -- fixed 1886dcd, route now resolves prices+seller currency SERVER-side from the DB, mirroring payment-intent exactly. Sweep rule: any surface touching cart/product prices must convert from Seller.currency; the header mini-basket was checked clean. (4) MARGIN FLAG for William (no change made): Stripe's fee applies to the gross charge incl. VAT+shipping; on micro-orders via fee-free seller-shipping lanes the flat 20p exceeds commission -- the 8.12 Door God order earns 0.27 commission vs ~0.32 Stripe fee (~5p loss). Options: minimum order value, or accept small losses on cheap items. His call.

EU EUR-3 LOW-VALUE DUTY IN THE ENGINE (2026-07-29, commit 09f4ccd, William raised it: "the eu is adding a 3 euro charge... has it been implemented yet" -- YES, live since 1 JULY 2026): the EU ended duty-free treatment for goods <= EUR 150 entering from outside; a flat EUR 3 PER ITEM transitional duty applies until the 2028 customs reform (Council agreed 2025-12-12, final sign-off 2026-02-11). lib/duty-rates.ts now charges GBP 2.60/item on below-threshold consignments entering the EU from OUTSIDE it (intra-EU duty-free; non-EU destinations unchanged); LandedCostParams gained itemCount, passed by payment-intent (group quantities) and the landed-cost quote route. Behaviour-tested all four lanes. Affects every CN->EU AND GB->EU Velor order (UK is outside the EU). REVISIT AT THE 2028 EU CUSTOMS REFORM -- the flat duty is transitional and real tariff schedules replace it. Also note: the deemed-supplier-style rules for EU (IOSS) still pend an EU launch decision per docs/VAT-OMP-POSITION.md.

QUICKBOOKS FULLY SET UP + BANKS CONNECTED (2026-07-29 evening, live in William's browser): the QuickBooks company was already registered as VELOR COMMERCE LTD (William's "old business account" worry was unfounded -- setup was simply unfinished). Completed the whole gbFlow setup: new to bookkeeping, under a year in business, industry "Wholesale Trade Agents and Brokers" (closest QB category to a commission marketplace -- no marketplace option exists; changeable in Settings), revenue <500K, Limited company (private), owner-run, business of one, wants VAT + receipts/expenses, receipts digital, no onboarding call (William is email-only, standing rule). BANKS CONNECTED VIA OPEN BANKING FEED, verified on the Bank transactions page: (1) Monzo current account -- 65 transactions imported, balance 256.17; (2) Tide current account ending 6975 -- IMPORTANT DISCOVERY: this IS the "CLEARBANK 6975" account from standing directive 5 / the Payoneer records (Tide runs on ClearBank underneath) -- mystery resolved, it's William's briefly-used Tide account (director's loan in/out + a couple of service payments live there, needed for the books); (3) Tide Instant Saver. 18 bank transactions pending categorisation -- the monthly bookkeeping task's job. Popup lesson: QuickBooks' bank-connect popup is blocked when the click comes from the extension -- William must click "Reopen window" HIMSELF (real user gesture); Tide's QR code 404'd but the flow completed anyway via manual sign-in. CONNECTOR DEAD END (confirmed 2026-07-29): Anthropic's Intuit QuickBooks connector is US-ONLY -- William's UK QuickBooks gets 'app isn't available for use in your country' at authorise time. NEVER tell him to reconnect it; it cannot work. QuickBooks data paths instead: bank feeds (automatic), receipt-forwarding by email (optional one-time setup in QuickBooks Transactions -> Receipts), and Claude driving the QuickBooks web UI in his browser during interactive sessions (categorising the pending transactions is a standing interactive-session chore). The monthly task prompt reflects this.
