...
- NEXT per LAW #4 order: stage 5 Workshop Feed (a VIEW over journals -- pull-model on Postgres, keyset pagination, NO algorithmic ranking per LAW #4 item 3), then Drop #1 + Founding Makers circle. Do not reorder.
