...
- Imagery: sourcing real, visually-verified Pexels photos per country, region by region ("cannot get this wrong" — wrong ones stay as honest "Opening soon" placeholders, never a wrong photo). **Waves 1-2 DONE & pushed** (Latin America+Caribbean 156 photos; East/SE Asia 102 photos). Waves 3+ pending. Method + remaining waves in the checkpoint doc; picks in docs/app-mockup/wave1_picks.py.
