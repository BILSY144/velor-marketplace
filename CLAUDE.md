...
- Imagery: sourcing real, visually-verified Pexels photos per country, region by region ("cannot get this wrong" — wrong ones stay as honest "Opening soon" placeholders, never a wrong photo). **Waves 1-6 DONE & pushed** (~800 verified photos; 118 countries). Waves 7+ pending: Africa (~50), North America + Oceania (~16). Method + remaining waves in the checkpoint doc; picks in docs/app-mockup/wave1_picks.py.
