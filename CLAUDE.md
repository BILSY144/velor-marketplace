...
- Imagery: sourcing real, visually-verified Pexels photos per country, region by region ("cannot get this wrong" — wrong ones stay as honest "Opening soon" placeholders, never a wrong photo). **Waves 1-4 DONE & pushed** (Latin America 156, East/SE Asia 102, South/Central Asia+Caucasus 83, Middle East 65 photos; 73 countries). Waves 5+ pending: Europe, Africa, N.America+Oceania. Method + remaining waves in the checkpoint doc; picks in docs/app-mockup/wave1_picks.py.
